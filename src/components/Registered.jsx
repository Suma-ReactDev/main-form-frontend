...
const Registered = () => {
  ...
  console.log('Registered Users Component is being Rendered')
  return (
    ...
    flex flex-col gap-5 '>
      ...
      <Link to='paginated' className='bg-slate-400 flex justify-center text-center p-5 text-2xl'>Paginated Component</Link>
